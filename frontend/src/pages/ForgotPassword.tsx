        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingTop: 48, paddingBottom: 32 }}>
          ...
          {sent ? (
            ...
            <div style={{
              ...
              <Link to="/login" style={{ fontSize: 13, color: '#3a3a3a', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: '2px' }}>
                ← Back to sign in
              </Link>
            </div>
          ) : (
            ...
            <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <p style={{ margin: 0, fontSize: 14, color: '#666', textAlign: 'center' }}>
                Remembered it?{' '}
                <Link to="/login" style={{ color: '#3a3a3a', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: '2px' }}>
                  Back to sign in
                </Link>
              </p>
            </form>
